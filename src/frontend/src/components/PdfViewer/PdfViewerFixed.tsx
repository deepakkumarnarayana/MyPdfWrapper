...
/**
 * PdfViewerFixed - Custom PDF Viewer with Advanced Highlighting
 * 
 * This is a CUSTOM PDF viewer implementation with:
 * - Advanced highlight system with coordinate transformations
 * - Custom text layer rendering and selection handling
 * - Performance optimizations with intersection observers
 * - Multiple highlight colors and storage capabilities
 * 
 * Status: EXPERIMENTAL - Use FullPdfViewer.tsx for production
 * Future: Improve coordinate system and text selection handling
 * 
 * Key Issues to Fix:
 * - Coordinate system alignment between text layer and highlights
 * - Text selection to PDF coordinate transformation
 * - Viewport scaling and rotation handling
...
export const PdfViewer: React.FC = () => {
  ...
  return (
    <Box sx={{ height: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      {/* Main content area with toolbar and viewer */}
      <Box sx={{ flex: 1, display: 'flex', overflow: 'hidden' }}>
        ...
        <PdfToolbar
          ...
          onHighlightSettingsChange={updateHighlightSettings}
        />
        ...
        <TableOfContentsDrawer
          ...
          onItemToggle={handleTocItemToggle}
        />
      </Box>
